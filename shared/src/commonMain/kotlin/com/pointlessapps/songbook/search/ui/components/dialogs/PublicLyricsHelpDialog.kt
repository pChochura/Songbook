...
import com.pointlessapps.songbook.shared.lyrics_i_understand
import com.pointlessapps.songbook.shared.lyrics_turn_it_off
import com.pointlessapps.songbook.shared.lyrics_what_is_public_lyrics
import com.pointlessapps.songbook.shared.lyrics_what_is_public_lyrics_description
...
internal fun PublicLyricsHelpDialog(
    ...
    SongbookDialog(
        ...
        dialogStyle = defaultSongbookDialogStyle().copy(
            label = stringResource(Res.string.lyrics_what_is_public_lyrics),
            icon = IconWarning,
        ...
        SongbookText(
            text = buildAnnotatedString {
                append(stringResource(Res.string.lyrics_what_is_public_lyrics_description))
                withLink(
                    LinkAnnotation.Url(
                        url = URL,
        ...
        Column(
            ...
            SongbookButton(
                ...
                label = stringResource(Res.string.lyrics_i_understand),
            ...
            SongbookButton(
                ...
                label = stringResource(Res.string.lyrics_turn_it_off),
