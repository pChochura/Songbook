...
import com.pointlessapps.songbook.shared.common_delete_the_song
import com.pointlessapps.songbook.shared.common_delete_the_song_description
...
internal fun ConfirmDeleteDialog(
    ...
    SongbookDialog(
        ...
        dialogStyle = defaultSongbookDialogStyle().copy(
            label = stringResource(Res.string.common_delete_the_song),
            icon = IconWarning,
            dismissible = SongbookDialogDismissible.OnBackPress,
        ),
    ) {
        SongbookText(
            text = stringResource(Res.string.common_delete_the_song_description),
